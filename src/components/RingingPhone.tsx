    ...
    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8 border border-gray-100">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className="group relative bg-gradient-to-r from-[var(--drk-red)] to-[var(--drk-red-dark)] hover:shadow-lg text-white py-4 px-6 rounded-xl font-semibold transition-all duration-200 hover:scale-105 flex items-center justify-center space-x-2"
        >
